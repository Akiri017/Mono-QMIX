...
function buildDashColors(isDark: boolean): DashColors {
  return isDark ? {
    ...
    isDark: false,
    pageBg: '#dde9f8',
    pageBgGrad: 'linear-gradient(135deg, #dde9f8 0%, #d5e3f5 40%, #e0edf9 100%)',
    obuBg: 'rgba(255,255,255,0.22)', obuBorder: 'rgba(255,255,255,0.75)',
    obuShadow: '0 32px 80px rgba(99,102,241,0.1), 0 8px 32px rgba(15,23,42,0.06), inset 0 1px 0 rgba(255,255,255,0.9)',
    screenBg: 'rgba(210,228,255,0.22)', screenBorder: 'rgba(255,255,255,0.6)',
    screenShadow: 'inset 0 1px 0 rgba(255,255,255,0.8)',
    screenGloss: 'linear-gradient(180deg, rgba(255,255,255,0.5) 0%, transparent 100%)',
    contentBg: 'rgba(255,255,255,0.45)', contentBorder: 'rgba(255,255,255,0.5)',
    sidebarBg: 'rgba(255,255,255,0.18)', sidebarBorder: 'rgba(255,255,255,0.5)',
    statusBg: 'rgba(255,255,255,0.45)', statusBorder: 'rgba(255,255,255,0.6)',
    glassBg: 'linear-gradient(155deg, rgba(255,255,255,0.72) 0%, rgba(255,255,255,0.52) 100%)',
    glassBorder: 'rgba(255,255,255,0.7)',
    glassShadow: 'inset 0 1px 0 rgba(255,255,255,0.9), 0 4px 24px rgba(99,102,241,0.07), 0 1px 4px rgba(15,23,42,0.06)',
    tp: '#111827', ts: '#374151', tm: '#6b7280', tu: '#9ca3af',
    divider: 'rgba(15,23,42,0.08)',
    badgeBg: 'rgba(255,255,255,0.55)', badgeBorder: 'rgba(255,255,255,0.8)', badgeColor: '#374151',
    itemBg: 'rgba(255,255,255,0.55)', itemBgMd: 'rgba(255,255,255,0.65)', itemBgHi: 'rgba(255,255,255,0.82)',
    chartGrid: 'rgba(15,23,42,0.07)',
    chartAxis: { fill: '#6b7280', fontSize: 10 },
    chartAxisLine: { stroke: 'rgba(15,23,42,0.12)' },
    chartTickLine: { stroke: 'rgba(15,23,42,0.1)' },
    chartLabel: '#6b7280',
    ...
    screwBg: 'linear-gradient(135deg,rgba(255,255,255,0.7),rgba(255,255,255,0.3))',
    screwShadow: 'inset 0 1px 2px rgba(15,23,42,0.06)',
    ...
    hoverBg: 'rgba(255,255,255,0.65)', hoverBgMd: 'rgba(255,255,255,0.85)', hoverColor: '#111827',
  }
}
